...
namespace MVCCapstoneBGS.Controllers
{
    ...
    public class EntitiesController : Controller
    {
        ...
        public ActionResult Test_Submitted(int StartDateMonth=1, int StartDateDay=1, int StartDateYear=1990, int EndDateMonth = 1, int EndDateDay = 1, int EndDateYear = 1990)
        {
            ...
            string x = "";
            foreach (var dataGive in _IDataProvider.GetStatusLWBetweenDates(1, StartDate, EndDate))
            {
                x +=
            ...
            _IDataProvider.CHART_DisplayBetweenDates(StartDate,EndDate, 1, out tempEnvironmentalConcernCount, out tempEnvironmentalConcern);
